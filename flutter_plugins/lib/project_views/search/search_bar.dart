...
class _SearchBarState extends State<SearchBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color iconColor = isDark ? Colours.dark_text_gray : Colours.dark_line;
      ...
      child: SizedBox(
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Image.asset(
              R.assetsImagesIconBackBlack,
              color: isDark ? Colours.dark_button_text : Colours.dark_text,
            ),
          ),
        ),
      ),
...
//          autofocus: true,
          ...
          decoration: InputDecoration(
            ...
            icon: Padding(
              ...
              child: LoadAssetImage(R.assetsImagesIconSearch, color: iconColor,),
            ),
            ...
            suffixIcon: GestureDetector(
              child: Semantics(
                ...
                child: Padding(
                  ...
                  child: LoadAssetImage(R.assetsImagesIconDelete, color: iconColor),
                ),
              ),
              onTap: () {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Material(
        color: isDark ? Colours.dark_bg_color : Colours.app_main,
        child: SafeArea(
          child: Row(
            children: <Widget>[
              back,

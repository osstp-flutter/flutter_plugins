...
import 'package:plugins/plugins_sample/easy_loading/test_page.dart';

class FlutterEasyLoadingPage extends StatefulWidget {
  FlutterEasyLoadingPage({Key? key, this.title}) : super(key: key);

  final String? title;

  @override
  _FlutterEasyLoadingPageState createState() => _FlutterEasyLoadingPageState();
}

void currentPageConfigLoading() {
...
class _FlutterEasyLoadingPageState extends State<FlutterEasyLoadingPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.title ?? 'EasyLoading'),
      ),
      body: Container(
